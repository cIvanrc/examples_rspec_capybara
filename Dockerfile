...
ARG IMAGE_NAME="test-app2:latest"

LABEL org.label-schema.build-date=$BUILD_DATE \
      org.label-schema.name="Test_app2" \
      org.label-schema.description="test_app2" \
      org.label-schema.vcs-url="https://github.com/IcaliaLabs/test-app2.git" \
